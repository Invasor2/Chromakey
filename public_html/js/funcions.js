...
/**
 * Métode per informa al navegador que vull realitzar una animació i sol·licita 
 * que el navegador programi el repintat de la finestra per al proper cicle d'animació. 
 * El mètode  requestAnimationFrame accepta com a argument una funció a la qual trucar abans d'efectuar el repintat.
 * @returns {undefined}
 */
function draw() {
...
/**
 * Métode per controlar el fluxe del video. Play/Pause
 * @returns {undefined}
 */
function Play() {
    if (!isPlaying) {
...
/**
 * Métode per dibujar en el canvas. 
 * Aquest programa està preparat per poder escollir si el fons del 
 * nostre video sigui: o imatge o un altre video.
 * @returns {undefined}
 */
...
/**
 * Métode en el que es defineixen els tipus de videos suportats per crear l'animació.
 * @returns {undefined}
 */
...
/**
 * Métode que ens permet poder fer servir videso com fons del nostroe video.
 * @returns {undefined}
 */
...
/**
 * Métode per carregar el video en el cas de que volguem que el fons sigui un video. 
 * @returns {String}
 */
